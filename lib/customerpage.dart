import 'package:ebanking_frontend_modile/accountpage.dart';
...
class _CustomerPageState extends State<CustomerPage> {
  ...
  void loadCustomers(){
    String url="http://192.168.217.1:8085/customers";
  ...
  void deleteCustomer(int index) {
    String url="http://192.168.217.1:8085/customers/"+index.toString();
